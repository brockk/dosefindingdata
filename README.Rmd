...
However, some of these are very sparsely reported.
...
131 studies report this outcome, with an average of 4.9 datapoints per series.
Efficacy outcomes are reported far less frequently but objective response as measured by RECIST [@Eisenhauer2009] is reported in over 50 studies.
...
## File format
The `database.xlsx` file contains many tabs.
