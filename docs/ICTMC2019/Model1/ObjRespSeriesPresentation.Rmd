---
title: "Model-based analyses for objective response outcomes"
...
series_ids <- obj_resp %>% distinct(AnalysisSeriesId) %>% .[[1]]

for(series_id in series_ids) {
  
  analysis <- analyse_obj_resp(series_id, alpha = alpha, add_title = FALSE)
