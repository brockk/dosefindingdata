...
for(series in obj_resp_series) {
  ...
  if(x$present) {
    ...
    object_name <- paste0('obj_resp_type1_brms_p1_diagnostics_', series)
  ...
  if(x$present) {
    ...
    object_name <- paste0('obj_resp_type1_brms_p2_diagnostics_', series)
    .cache_save(object, object_name)
  } else {
    warning(paste0('Object ', sought_object_name, ' not present.'))
  }
  ...
  if(x$present) {
    ...
    object_name <- paste0('obj_resp_type2_brms_p1_diagnostics_', series)
    .cache_save(object, object_name)
  } else {
    warning(paste0('Object ', sought_object_name, ' not present.'))
  }
  ...
  if(x$present) {
    ...
    object_name <- paste0('obj_resp_type2_brms_p2_diagnostics_', series)
    .cache_save(object, object_name)
  } else {
    warning(paste0('Object ', sought_object_name, ' not present.'))
  }
